"""From https://github.com/BloodAxe/pytorch-toolbelt/blob/develop/pytorch_toolbelt/inference/functional.py"""  # noqa
...
def pad_image_tensor(image_tensor: Tensor, pad_size: Union[int, Tuple[int, int]] = 32):
    ...
    :return: Tuple of output tensor and pad params.
        Second argument can be used to reverse pad operation of model output
    """
    ...
    if (
        ...
        raise ValueError(
            f"Unsupported pad_size: {pad_size}, must be either tuple(pad_rows,pad_cols) or single int scalar."  # noqa
        )
